...
const Home = forwardRef(({ onExploreServices, onReservaClick }, ref) => {
  ...
  const servicesData = {
    ...
    "Belleza": [
      ...
      { id: 11, name: "Peinado para eventos", duration: "40 min", price: "$35-60", category: "Belleza", image: "👰", description: "Peinados elegantes para ocasiones especiales con fijación profesional que garantiza durabilidad.", benefits: "Diseño exclusivo, productos de larga duración, look fotográfico" },
      { id: 12, name: "Tinte/coloración", duration: "60 min", price: "$40-70", category: "Belleza", image: "🌈", description: "Coloración profesional con productos de calidad que protegen el cabello y mantienen su vitalidad.", benefits: "Color vibrante, cubrimiento de canas, fórmula protectora" },
      { id: 13, name: "Mechas/balayage", duration: "60 min", price: "$60-100", category: "Belleza", image: "🎨", description: "Técnicas de iluminación personalizadas para crear dimensiones y reflejos naturales con un efecto sun-kissed.", benefits: "Efecto natural, bajo mantenimiento, personalizado" },
      ...
      { id: 15, name: "Alisado/keratina", duration: "60 min", price: "$80-150", category: "Belleza", image: "🔀", description: "Tratamientos profesionales de alisado con fórmulas avanzadas que protegen la fibra capilar.", benefits: "Manejabilidad, reducción de frizz, efecto duradero" },
      { id: 16, name: "Extensiones de cabello", duration: "60 min", price: "$100-250", category: "Belleza", image: "👑", description: "Aplicación profesional de extensiones de cabello de alta calidad con métodos seguros y naturales.", benefits: "Volumen instantáneo, longitud adicional, resultado natural" },
    ],
    ...
    "Manos y Pies": [
      ...
      { id: 21, name: "Uñas acrílicas", duration: "50 min", price: "$40-60", category: "Manos y Pies", image: "💅", description: "Aplicación profesional de uñas acrílicas con formas y longitudes personalizadas según tu preferencia.", benefits: "Durabilidad, resistencia, personalización de forma" },
      { id: 22, name: "Uñas de gel", duration: "50 min", price: "$35-50", category: "Manos y Pies", image: "💅", description: "Esmaltado semipermanente que mantiene tus uñas perfectas por semanas con brillo intenso.", benefits: "Brillo prolongado, cero secado, hasta 3 semanas de duración" },
    ...
    "Spa y Bienestar": [
      ...
      { id: 28, name: "Tratamiento facial completo", duration: "45 min", price: "$45-70", category: "Spa y Bienestar", image: "✨", description: "Limpieza profunda, exfoliación, extracción, mascarilla y masaje facial personalizado según tu tipo de piel.", benefits: "Piel renovada, poros limpios, hidratación intensiva" },
      { id: 30, name: "Depilación corporal (por zona)", duration: "55 min", price: "$20-40", category: "Spa y Bienestar", image: "✨", description: "Depilación profesional por zonas con productos hipoalergénicos y técnicas que reducen el crecimiento futuro.", benefits: "Piel suave, menos rebrote, precisión en cada zona" },
